...
const ContributorProfiles = ({FirstName,LastName,source}) => {
  return (
    <div>
        <section className=" bg-black flex font-medium items-center justify-center h-auto p-10">

    <section className="w-64 lg:w-[300px] mx-auto bg-black border border-gray-600 rounded-2xl px-8 py-6 shadow-lg">
