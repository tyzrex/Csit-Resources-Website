...
const Footer = () => {
  AOS.init();
  return (
    <div data-aos='fade-down' data-aos-duration='500' className='bg-black border border-l-0 border-r-0 border-t-gray-600'>
<div className='max-w-[420px] sm:max-w-[600px] md:max-w-[1500px] bg-black mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8  text-white'>
      <div>
        <h1 className='w-full text-3xl text-center lg:text-left font-bold text-white'>GYAN<span className='text-red-600'>HUB</span></h1>
        <p className='py-4 text-center lg:text-left'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Id odit ullam iste repellat consequatur libero reiciendis, blanditiis accusantium.</p>
        <div className='grid gap-8 grid-flow-col content-center justify-items-center md:w-full my-6'>
